...
class App {
  ...
  next() {
    ...
    const nextItem = width * nextIndex;
    this.scroll.target = -nextItem;
  }
...
const CircularGallery = forwardRef<CircularGalleryRef, CircularGalleryProps>(({
  ...
  }, [items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, onServiceChange]);

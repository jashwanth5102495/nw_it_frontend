      ...
      <svg ref={svgRef} className="eb-svg" aria-hidden focusable="false">
        <defs>
          <filter id={filterId} colorInterpolationFilters="sRGB" x="-20%" y="-20%" width="140%" height="140%">
            ...
            <feComposite in="offsetNoise1" in2="offsetNoise2" operator="add" result="combinedNoise1" />
            <feComposite in="offsetNoise3" in2="offsetNoise4" operator="add" result="combinedNoise2" />
            <feComposite in="combinedNoise1" in2="combinedNoise2" operator="add" result="finalNoise" />
            <feDisplacementMap in="SourceGraphic" in2="finalNoise" scale="30" />
          </filter>
        </defs>
      </svg>

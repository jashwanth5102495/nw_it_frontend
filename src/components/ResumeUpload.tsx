...
import { Entropy } from './animate-ui/primitives/graphics/entropy';
    ...
    <section className="bg-black py-24 relative overflow-hidden">
      ...
      <div className="w-full px-0 relative z-10">
        <div className="grid md:grid-cols-2 gap-10 items-stretch">
          {/* Left-side Entropy outside the application box */}
          <div className="hidden md:flex">
            <div className="w-full min-h-[520px] bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 md:p-16 flex items-center justify-center">
              <Entropy size={420} className="rounded-xl border border-white/10" />
            </div>
          </div>
          {/* Right-side Internship Application box */}
          <div className="w-full">
            <CursorProvider>
              <CursorContainer className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-12 md:p-16 min-h-[520px]">
                {/* Cursor visuals */}
                <Cursor>
